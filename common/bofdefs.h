...
DECLSPEC_IMPORT WINBASEAPI HWINSTA WINAPI USER32$GetProcessWindowStation (void);
WINUSERAPI HDESK WINAPI USER32$GetThreadDesktop (DWORD);
...
DECLSPEC_IMPORT WINADVAPI DWORD WINAPI ADVAPI32$GetSecurityInfo(HANDLE,SE_OBJECT_TYPE,SECURITY_INFORMATION,PSID*,PSID*,PACL*,PACL*,PSECURITY_DESCRIPTOR*);
DECLSPEC_IMPORT WINBASEAPI PVOID WINAPI ADVAPI32$FreeSid (PSID);
DECLSPEC_IMPORT WINADVAPI DWORD WINAPI ADVAPI32$SetEntriesInAclA(ULONG,PEXPLICIT_ACCESS_A,PACL,PACL*);
WINADVAPI DWORD WINAPI ADVAPI32$SetSecurityInfo(HANDLE,SE_OBJECT_TYPE,SECURITY_INFORMATION,PSID,PSID,PACL,PACL);
WINBASEAPI BOOL WINAPI ADVAPI32$AllocateAndInitializeSid( PSID_IDENTIFIER_AUTHORITY, BYTE, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, PSID *);
...
// PSAPI
// this need to be exported differently for whatever reason
...
DECLSPEC_IMPORT DWORD WINAPI KERNEL32$K32GetProcessImageFileNameA(HANDLE,LPSTR,DWORD);
...
#define KERNEL32$QueueUserAPC QueueUserAPC
...
//CUSTOM
#define USER32$GetProcessWindowStation GetProcessWindowStation
#define USER32$GetThreadDesktop GetThreadDesktop
#define KERNEL32$GetCurrentThreadId GetCurrentThreadId
#define ADVAPI32$GetSecurityInfo GetSecurityInfo
#define ADVAPI32$FreeSid FreeSid
#define ADVAPI32$SetEntriesInAclA SetEntriesInAcl
#define ADVAPI32$AllocateAndInitializeSid AllocateAndInitializeSid
#define ADVAPI32$SetSecurityInfo SetSecurityInfo
...
#define KERNEL32$GetCurrentProcess GetCurrentProcess
#define KERNEL32$GetLastError GetLastError
#define KERNEL32$K32EnumProcesses EnumProcesses
#define KERNEL32$K32EnumProcessModulesEx EnumProcessModulesEx
#define KERNEL32$K32GetModuleBaseNameA GetModuleBaseNameA
#define KERNEL32$IsWow64Process IsWow64Process
#define KERNEL32$K32GetProcessImageFileNameA GetProcessImageFileNameA
